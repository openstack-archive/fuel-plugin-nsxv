...
Plugin versions:
* 1.x.x series is compatible with Fuel 7.0. Tests were done on
plugin v1.2 with VMware NSX 6.1.4.
* 2.x.x series is compatible with Fuel 8.0. Tests were done on
plugin v2.0 with VMware NSX 6.2.
