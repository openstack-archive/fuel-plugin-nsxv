...
Option 'Use mgmt network to access the metadata server' (nsxv_mgt_via_mgmt) was disabled by default.
...
Test case verifies option nsxv_mgt_via_mgmt in enabled state, nsxv_mgt_reserve_ip is disabled.
...
#####
    ...
    1. Configure cluster.
    2. Install fuel and nsxv plugin and enable option 'Use mgmt network to access the metadata server' (nsxv_mgt_via_mgmt).
    3. Configure nsxv plugin.
       Manually specify the IP address, network mask and default route for the proxy metadata router.
    4. Launch instance and run command from it::
...
#####
    ...
    1. Configure cluster.
    2. Install fuel and nsxv plugin.
    3. Configure nsxv plugin and enable both options 'Use mgmt network to access the metadata server' (nsxv_mgt_via_mgmt),
