...
class TestNSXvPlugin(TestBasic):
    ...
    def nsxv_add_delete_nodes(self):
        ...
        Scenario:
            ...
            2. Install plugin.
            3. Create cluster with vcenter.
            4. Add 3 nodes with controller role, compute-vmware.
            5. Deploy cluster.
            6. Run OSTF.
            7. Add node cinder-vmware.
            8. Redeploy cluster.
            9. Run OSTF.
           10. Remove node cinder-vmware.
           11. Redeploy cluster.
           12. Run OSTF.
           13. Remove node compute-vmware.
           14. Redeploy cluster.
           15. Run OSTF.
        ...
        self.fuel_web.vcenter_configure(cluster_id, vcenter_value)
        self.fuel_web.deploy_cluster_wait(cluster_id, check_services=False)
