...
class TestNSXvPlugin(TestBasic):
    ...
    def _get_common(self, cluster_id):
    ...
    def _create_net_public(self, cluster_id):
        """Create custom exteral net and subnet"""

        common = self._get_common(cluster_id)
    ...
    def nsxv_smoke(self):
        ...
        common = self._get_common(cluster_id)
        private_net = common.create_network('net04')
        subnet_private = common.create_subnet(private_net, '10.100.0.0/24')
        public_net = self._create_net_public(cluster_id)
        router = common.add_router('connecting_router', public_net)
        common.add_subnet_to_router(router['id'], subnet_private['id'])
    ...
    def nsxv_ha_mode(self):
        ...
        private_net = os_conn.create_network('net04')
        os_conn.create_subnet(private_net, '10.100.0.0/24')
        self._create_net_public(cluster_id)
