...
class TestNSXvPlugin(TestBasic):
    ...
    def nsxv_same_ip_different_tenants(self):
        ...
        tenant2_subnet = hos_t1.create_subnetwork(tenant_2_net_1,
        ...
        tenant1_router = os_conn.create_router("t1", tenant_1_name)
    ...
    def nsxv_different_tenants(self):
        ...
        Scenario:
            1. Setup nsxv_ha_mode
            2. Create non-admin tenants 'test'.
            ...
            9. In default tenant create net1 with subnet1 and subnet2
               (same CIDRs).
            10. In default tenant create security group 'SG_1' and
                add rule that allows ingress icmp and tcp traffic.
            11. Launch instance in default tenant.
