...
from helpers.tools import find_first, ShowPos
...
class HopenStack(ShowPos):
    ...
    def tenants_create(self, tenant_name):
        """Creates tenant with given name
        """
        ...
        if tenant is None:
            ...
            logger.warning("Tenant already exist, name: '{0}' id: '{1}'".format(
                tenant_name, tenant.id))
        return tenant
    ...
    def security_group_add_rule(self, tenant_id, group):
        ...
        try:
            ...
            logger.warning("Can't create rule for tenant {}. Exception: {}",
                           tenant_id, e)
